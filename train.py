...
if __name__ == "__main__":
    ...
    val_set = DatasetFromFolder('data/val', upscale_factor=UPSCALE_FACTOR, input_transform=transforms.ToTensor(),
                                target_transform=transforms.ToTensor())
    train_loader = DataLoader(dataset=train_set, num_workers=4, batch_size=200, shuffle=True)
    val_loader = DataLoader(dataset=val_set, num_workers=4, batch_size=200, shuffle=False)
